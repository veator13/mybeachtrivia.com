...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof firebase === 'undefined' || typeof firebase.initializeApp !== 'function') {
        ...
        if (messageContainer) {
            messageContainer.innerHTML = '<div class="message error">Authentication service unavailable. Please refresh the page or check your internet connection.</div>';
    ...
    try {
                    ...
                    if (!isActiveLogin) {
                        ...
                        db.collection('employees')
                            ...
                            .catch(error => {
                                ...
                                showMessage('error', 'Error loading user data. Please try again.');
                            });
                    }
                }
            }
        ...
        const messageContainer = document.getElementById('messageContainer');
        if (messageContainer) {
            messageContainer.innerHTML = `<div class="message error">Error initializing authentication service: ${error.message}</div>`;
            messageContainer.style.display = 'block';
        }
    }
});