...
(function () {
  ...
  function renderHost() {
    ...
    window.BeachTriviaSlidePaint.paintSlide(dom['host-stage'], slide, showHostAnswer, { scaleToFit: true });
  ...
  function renderCast() {
    ...
    window.BeachTriviaSlidePaint.paintSlide(dom['cast-stage'], slide, showAnswer, { scaleToFit: true });
