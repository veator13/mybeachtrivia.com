...
(() => {
  ...
  const ASSET_V = "20260831-mobile12";
  ...
  const PRECACHE_URLS = [
    ...
    "/beachTriviaPages/dashboards/host/scoresheet/style.css?v=20260831-mobile12",
    ...
    "/beachTriviaPages/dashboards/host/scoresheet/js/mobile-scoring.js?v=20260831-mobile12",
