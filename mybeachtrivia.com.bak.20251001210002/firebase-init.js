...
(function () {
    ...
    const firebaseConfig = {
      ...
      authDomain: "beach-trivia-website.firebaseapp.com", // <— run handler on web.app (safe for redirect)
...
// speed: avoid slow IndexedDB persistence
firebase.auth().setPersistence(firebase.auth.Auth.Persistence.NONE).catch(console.log);
