try{console.log("[guard] file start"); performance.mark("guard_start");}catch(e){}
        ...
        if (typeof firebase !== 'undefined' && firebase.auth) {
            ...
            firebase.auth().onAuthStateChanged(user => {
                if (user) {
                    ...
                    catch(e){} try{console.log("[guard] redirecting"); performance.mark("guard_redirect");}catch(e){} ; location.href = '/login.html';
                }
            }, error => {
