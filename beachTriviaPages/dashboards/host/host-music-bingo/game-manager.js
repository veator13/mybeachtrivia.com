...
export async function playCurrentSong() {
  ...
  try {
    ...
    if (isSpotifyReady()) {
      ...
      // Here you would actually play the song using fallback method
...
export async function playNextSong() {
  ...
  try {
    ...
    if (isSpotifyReady()) {
      ...
      // Here you would play the song using fallback method
...
export async function resumeGame(gameId = null) {
  ...
  try {
    ...
    // If Spotify player is available, resume the playback
    if (isSpotifyReady()) {
      import('./spotify-service.js').then(module => {
        module.togglePlayback();
      });
...
export async function endGame() {
  ...
  try {
    // Only confirm if game isn't already ended
